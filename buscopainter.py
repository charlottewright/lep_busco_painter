...
def print_location_table(reference_table_dict, query_table_dict, location_table_file):
	with open(location_table_file, 'w') as location_table:
		location_table.write("%s\t%s\t%s\t%s" % ("buscoID", "query_chr", "position", "assigned_chr") + "\n")
		for buscoID, position_list in query_table_dict.items():
			query_chr, query_start, query_stop = position_list
...
if __name__ == "__main__":
	...
	print_summary_table(reference_table_dict, reference_chr_list, query_table_dict, query_chr_list, summary_table_file)
	print_location_table(reference_table_dict, query_table_dict, location_table_file)
